      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-bgPanel border border-red-500/20 rounded-3xl shadow-2xl overflow-hidden p-8"
          >
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <h3 className="text-xl font-black text-textPrimary mb-2 tracking-tight">
                {title}
              </h3>
              ...
              <div className="flex flex-col w-full gap-3">
                ...
                <button
                  onClick={onClose}
                  className="w-full bg-bgSurfaceHover hover:bg-bgSurfaceActive text-textMuted hover:text-textPrimary py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all"
                >
                  Fechar
                </button>
              </div>
