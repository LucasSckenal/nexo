...
export default function MembersPage() {
  ...
  return (
    <main className="flex-1 p-6 lg:p-10 bg-bgMain relative overflow-y-auto custom-scrollbar h-full">
      ...
      <div className="max-w-6xl mx-auto space-y-10 relative z-10">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-bgGlass border border-borderGlass px-4 py-2 rounded-xl flex items-center gap-6 backdrop-blur-md">
              ...
              <div className="w-px h-8 bg-borderFocus" />
              <div className="text-center">
                <p className="text-[10px] font-black uppercase text-textMuted tracking-widest">
                  Online
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 relative group">
            <Search
              className="absolute left-4 top-1/2 -translate-y-1/2 text-textMuted group-focus-within:text-indigo-500 transition-colors"
              size={18}
            />
            <input
              type="text"
              ...
              className="w-full bg-bgSurface/60 border border-borderGlass rounded-2xl py-4 pl-12 pr-4 text-sm text-textPrimary placeholder:text-textMuted outline-none focus:border-indigo-500/50 transition-all backdrop-blur-md"
            />
          </div>
            ...
            <AnimatePresence mode="popLayout">
              {filteredMembers.map((member: any, index: number) => (
                <motion.div
                  ...
                  className="group relative bg-bgSurface/40 border border-borderGlass rounded-[2rem] p-6 hover:bg-bgGlassHover hover:border-borderFocus transition-all duration-500 overflow-hidden"
                >
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    <div className="relative">
                      <img
                        ...
                        alt={member.name}
                        className="w-16 h-16 rounded-2xl object-cover border border-borderFocus group-hover:scale-105 transition-transform duration-500"
                      />
                      <div className="absolute -bottom-2 -right-2 bg-bgMain p-1 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-bold text-textPrimary truncate group-hover:text-indigo-400 transition-colors">
                        {member.name}
                      </h3>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded-md bg-bgSurfaceHover border border-borderFocus text-[10px] font-bold text-textSecondary uppercase tracking-tighter">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-4 border-t border-borderGlass">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-bgSurfaceHover hover:bg-bgSurfaceActive text-textSecondary hover:text-textPrimary text-xs font-bold transition-all"
                    >
                  ...
                  <div className="mt-4 flex items-center gap-4 text-[10px] text-textMuted font-medium">
        ...
        {!isLoading && filteredMembers.length === 0 && (
          <div className="py-20 text-center">
            <div className="w-20 h-20 bg-bgSurfaceHover rounded-full flex items-center justify-center mx-auto mb-4 border border-dashed border-borderFocus">
              <Users className="text-textMuted" size={32} />
            </div>
            <h3 className="text-textPrimary font-bold">Nenhum membro encontrado</h3>
