...
export default function SettingsPage() {
  ...
  return (
    <main className="flex-1 flex flex-col h-full bg-[#050505] relative overflow-hidden text-zinc-200">
      <AnimatePresence>
        {toast.show && (
          <motion.div
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 lg:p-10 z-10 pb-32">
        <div className="w-full max-w-[1000px] mx-auto mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
          <div>
